...
if %errorlevel% neq 0 (
    echo Ollama is not running. Please start Ollama manually with: ollama serve
...
if %errorlevel% neq 0 (
    echo Backend may still be starting. Please wait a moment and check http://localhost:8000/health
)
